...
public class CoordMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            //CoordinateTD cNSd_err =  new CoordinateTD(Direction.LATITUDE, 108, 0, 0);
            //CoordinateTD cEWd_err =  new CoordinateTD(Direction.LONGITUDE, -195, 0, 0);
            //CoordinateTD cm_err =  new CoordinateTD(Direction.LATITUDE, 66, -3, 0);
            //CoordinateTD cs_err =  new CoordinateTD(Direction.LATITUDE, 25, 0, 99);
            ...
            CoordinateTD cEW1 = new CoordinateTD(Direction.LONGITUDE, -115, 23, 6);
            CoordinateTD cEW2 = new CoordinateTD(Direction.LONGITUDE, 151, 0, 34);
